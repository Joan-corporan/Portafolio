...
export const NavbarOrigin = () => {
  return (
    <nav className="flex flex-col items-center xl:justify-center gap-y-4 fixed h-max bottom-0 mt-auto xl:right-[2%] z-50 top-0 w-full xl:w-[80px] xl:max-w-md xl:h-screen bg-[#FAD051] ">
